...
let observe = require("../utils/events");
...
class InputPrompt extends Base {
  ...
  _run(cb) {
    ...
    let submit = events.line.pipe(map(this.filterInput.bind(this)));

    let validation = this.handleSubmitEvents(submit);
